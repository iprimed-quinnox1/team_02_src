var placeOrderServerController = require("../controllers/placeOrderController.server");

module.exports = function(app){
    app.route("/order/placeOrder").post(placeOrderServerController.placeOrder);
}
/*var express = require('express');
var router = express.Router();
var mon = require("../controllers/db_placeOrder.js");
